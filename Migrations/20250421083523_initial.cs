        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberDiscordId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    Type = table.Column<int>(type: "INTEGER", nullable: false),
                    Level = table.Column<int>(type: "INTEGER", nullable: false),
                    Personality = table.Column<int>(type: "INTEGER", nullable: false),
                    PersonalityLeft = table.Column<int>(type: "INTEGER", nullable: false),
                    Empathy = table.Column<int>(type: "INTEGER", nullable: false),
                    Intelligent = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmmoType = table.Column<int>(type: "INTEGER", nullable: true),
                    Protection = table.Column<int>(type: "INTEGER", nullable: true),
                    IsWearable = table.Column<bool>(type: "INTEGER", nullable: true),
                    MagazineType = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    ROF = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoadedMagGuid = table.Column<Guid>(type: "TEXT", nullable: false),
                    Quantity = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvItems", x => new { x.InventoryId, x.ItemId });
                    table.ForeignKey(
                        name: "FK_InvItems_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvItems_Items_ItemId",
                        column: x => x.ItemId,
